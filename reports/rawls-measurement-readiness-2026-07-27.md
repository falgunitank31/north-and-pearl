...
| GA4 Realtime receipt | Still needs UI verification | Must be checked inside GA4 after live traffic/test actions. |
...
1. Open GA4 Realtime and confirm a live page view appears after visiting the site.
2. Trigger a product view and add-to-cart event and verify whether GA4 receives them.
3. Confirm Shopify Analytics can report sessions, product views, add-to-cart, checkout starts, purchases, and revenue.
4. Re-check Search Console sitemap status after Google retries the submitted sitemap.
5. Record first baseline only after verified data is available. Do not invent traffic, conversion, revenue, or ranking numbers.
