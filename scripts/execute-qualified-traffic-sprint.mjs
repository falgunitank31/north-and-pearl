...
function articleHtml() {
  return [
    ...
    '<ul>',
    '<li><a href="/products/north-pearl-initial-shell-necklace">North & Pearl Initial Shell Necklace</a>: an initial-style necklace for a small personal detail.</li>',
    '<li><a href="/products/north-pearl-heart-keepsake-necklace">North & Pearl Heart Keepsake Necklace</a>: a heart-led keepsake style for meaningful gifting.</li>',
    '<li><a href="/products/north-pearl-polished-link-bracelet">North & Pearl Polished Oval Link Bracelet</a>: an easy bracelet starting point for everyday gifting.</li>',
    '</ul>',
