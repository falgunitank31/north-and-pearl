...
- Rawls/Tesla must connect reliable Shopify or GA4 funnel totals into the Agent Command Center for the new August 8 order goals. Current dashboard tracks verified orders and organic sessions, but product views, add-to-carts, and checkout starts remain 0 placeholders until the data source is wired.
