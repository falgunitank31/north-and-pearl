...
- August 11 catalog expansion baseline: active catalog remains documented at 208 products; the August 11 strict Alibaba sourcing pipeline has 17 raw candidates, 17 exact Alibaba URLs recorded, 0 approved, 0 Shopify-ready, and 0 published. Batch 1 is staged in `docs/sourcing/aug11-batch1-gate-register.csv` pending image/IP visual screening and commercial validation.
