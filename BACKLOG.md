...
- **✅ FIXED: GA4 ecommerce instrumentation fix deployed** (Aug 9, 2026 3c97173). The GA4 bridge script was waiting for DOMContentLoaded, but the deferred script loads AFTER that event fires. Fixed by checking document.readyState instead. Deployed to live theme 189441802424 via Shopify theme editor. Next: Run Aug 10 daily order-goal block to verify select_item and view_item events now fire when visitors land on pages.
