...
- [ ] Tesla/Rawls next measurement task: connect reliable product-view, add-to-cart, checkout-start, and order funnel totals into the Agent Command Center instead of showing only currently verified order/organic/session values.
